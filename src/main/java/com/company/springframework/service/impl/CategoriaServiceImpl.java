...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    public Categoria actualizarCategoria(Categoria categoria) {
        ...
        if (!categoriaRepository.existsById(categoria.getIdCategoria())) {
            throw new IllegalArgumentException("La categoría con el Identificador especificado no existe");
        }
        return categoriaRepository.save(categoria);
    }
    ...
    public void eliminarCategoria(Long idCategoria) {
        ...
        throw new IllegalArgumentException("Categoria Eliminada correctamente");
