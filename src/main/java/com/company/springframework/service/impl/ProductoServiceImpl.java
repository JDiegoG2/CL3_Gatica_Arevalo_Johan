...
public class ProductoServiceImpl implements ProductoService {
    ...
    public Producto actualizarProducto(Producto producto) {
        ...
        if (!productoRepository.existsById(producto.getId())){
            throw new IllegalArgumentException("El producto con el Identificador especificado no existe.");
        }
        return productoRepository.save(producto);
    }
    ...
    public void eliminarProducto(Long id) {
        ...
        throw new IllegalArgumentException("Producto Eliminado correctamente");
    ...
    private void validarProducto(Producto producto) {
        ...
        if (producto.getEstado() < 0) {
            throw new IllegalArgumentException("ERROR: El estado no puede ser negativo.");
        }
        if (producto.getCategoria() == null || producto.getCategoria().getIdCategoria() == null) {
            throw new IllegalArgumentException("ERROR: La categoría asignada no es válida.");
        }
    }
